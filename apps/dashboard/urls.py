...
urlpatterns = [
    ...
    path('dashboard/admin/users/<int:pk>/', views.admin_user_detail, name='admin_user_detail'),
    ...
    path('dashboard/admin/users/<int:pk>/delete-farmer-card/<int:card_id>/', views.admin_delete_farmer_card, name='admin_delete_farmer_card'),
    path('dashboard/admin/users/<int:pk>/delete-ration-card/<int:card_id>/', views.admin_delete_ration_card, name='admin_delete_ration_card'),
    path('dashboard/admin/users/<int:pk>/delete-customer/<int:customer_id>/', views.admin_delete_customer, name='admin_delete_customer'),
    path('dashboard/admin/cards/farmer/<int:pk>/print/', views.admin_print_farmer_card, name='admin_print_farmer_card'),
    path('dashboard/admin/cards/ration/<int:pk>/print/', views.admin_print_ration_card, name='admin_print_ration_card'),
